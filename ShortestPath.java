	...
	private int getInt(char c) {
		...
		public void input(String filename) throws IOException {
			...
			try {
				...
				fd=new FileReader(new File("C:/Users/Nirja/Documents/input3.txt"));
		...
		public static void main(String[] args) throws IOException {
			...
			ob.displayResult();
			System.out.println("\n");
			System.out.println("The time taken for the execution of Dijkstra's Algorithm is: " + (endtime-starttime)+ " nanoseconds");
			}
		}
